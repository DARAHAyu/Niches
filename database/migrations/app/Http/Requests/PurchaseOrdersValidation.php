...
//*************************************************************
// Rule
//1.  use App\Http\Requests\PurchaseOrdersValidation; //Add Controller
//2.  public function store( PurchaseOrdersValidation $request ){ //example
//*************************************************************

class PurchaseOrdersValidation extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"purchase_abstract" => "required", //text('purchase_abstract')
