...
//*************************************************************
// Rule
//1.  use App\Http\Requests\MessageRoomsValidation; //Add Controller
//2.  public function store( MessageRoomsValidation $request ){ //example
//*************************************************************

class MessageRoomsValidation extends FormRequest
{
    /**
