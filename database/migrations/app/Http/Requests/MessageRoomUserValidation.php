...
//*************************************************************
// Rule
//1.  use App\Http\Requests\MessageRoomUserValidation; //Add Controller
//2.  public function store( MessageRoomUserValidation $request ){ //example
//*************************************************************

class MessageRoomUserValidation extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
				...
				"message_room_id" => "required|integer", //integer('message_room_id')
